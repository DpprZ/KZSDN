...
public class AddComment1 {
    public boolean addcomment(Comments cmt) throws Exception{
        ...
        //
        String sql="INSERT INTO comment(comment,user,blogid,sendtime,rate,commentid,superid,supername) VALUES(?,?,?,?,?,?,?,?)";
        ...
        statement.setString(7,cmt.getSuperid());
        statement.setString(8,cmt.getSupername());
