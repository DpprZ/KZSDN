...
<body>
<div>
    <form role="form" method="post" name="form" id="form" action="writeblog">
    </form>
...
<div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <input form="form" type="text"  id="ttle" name="ttle" placeholder="请输入文章标题" style="left:300px ;height: 35px;width: 700px"  >
            <button id="triggerBtn" style="background-color: red">发布博客</button>
        </div>
    </div>
</div>
<div id="my-editormd" >
    <textarea form="form" id="my-editormd-markdown-doc" name="my-editormd-markdown-doc" style="display:none;"></textarea>
    <!-- 注意：name属性的值-->
    <textarea form="form" id="my-editormd-html-code" name="my-editormd-html-code" style="display:none;"></textarea>
</div>
<!-- 模态框 -->
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="form-group">
                <label for="label"><font >标签</font></label><input form="form" type="text" class="form-control" id="label" name="label" placeholder="请输入文章标签" />
