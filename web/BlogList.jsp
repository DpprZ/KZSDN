...
<div class="container">
    <div class="row clearfix">
                ...
                <ul>
                    ...
                    <div>
                        <c:forEach items="${categorys}" var="item">
                            <form role="form" method="post" id="form777" action="showcategory">
                        ...
                        <form role="form" method="post" id="form7" action="showcategory">
        ...
        <div class="col-md-9 column" style="position: relative">
            <form role="form" method="post" id="form77" action="showdate">
            <input type="date" value="选择日期" id="searchdate" name="searchdate">
            <input type="submit" value="查找">
            </form>
            <c:if test="${checkstr=='sb'}">
           <c:forEach items="${blogss}" var="item">
               <div class="blog" >
               <div>
                ...
                <c:forEach items="${blogs}" var="item">
                    ...
                    <div class="blog" >
                        ...
                        <div>
                            ...
                            <form role="form" method="post" id="form31" action="modifyblog">
                                <input type="hidden" value="${item.id}" id="modify_id1" name="modify_id1">
                                <div class="item_right"><span><input type="submit" id="modifybt1" name="modifybt1" value="编辑"></span></div>
                            </form>
                            <form role="form" method="post" id="form21" action="deleteblog">
                                <input type="hidden" value="${item.id}" id="delete_id1" name="delete_id1">
                                <div class="item_right"><span><input type="submit" id="deletebt1" name="deletebt1" value="删除"> </span></div>
                            </form>
                        </div>
                    </div>
                    <hr>
    ...
    <%-- <c:if test="${checkstr=='sb'}">   --%>
    <div>
        <form role="form" method="post" id="form211" action="lastpage"></form>
        <form role="form" method="post" id="form2112" action="nextpage">  </form>
        <input form="form211" type="hidden" id="username" name="username" value="${user.username}">
        <input form="form2112" type="hidden" id="username2" name="username2" value="${user.username}">
